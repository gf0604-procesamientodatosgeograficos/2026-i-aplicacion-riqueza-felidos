...
# Mapa de coropletas de riqueza por área de conservación, con los registros
# de presencia (agrupados) encima. Todo se recalcula con los datos filtrados.
output$mapa <- renderLeaflet({
  ...
  leaflet() |>
    ...
    addLayersControl(
      ...
      overlayGroups = c("Riqueza por área de conservación", "Félidos"),
