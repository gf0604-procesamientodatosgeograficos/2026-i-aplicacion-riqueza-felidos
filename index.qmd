...
# Mapa interactivo. Reacciona a los datos filtrados y, además, al control de
# visualización de registros (agrupados / individuales / mapa de calor).
output$mapa <- renderLeaflet({
  ...
  # Áreas de conservación con relleno de coropleta de riqueza (+ leyenda).
  mapa <- mapa |>
    addPolygons(
      data        = areas_riqueza,
      weight      = 1,
